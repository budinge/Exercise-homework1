		...
		<div class="content">
			<div class="am-g">
				...
				<div class="am-u-sm-12">
					<div class="card-box">
						<h4 class="header-title m-t-0 m-b-30">请选择需要绘制的数据</h4>
						<div class="am-g">
							<div class="am-u-md-12">
								<form  action="__APP__?g=<?php echo GROUP_NAME;?>&m=<?php echo MODULE_NAME;?>&a=scatter" method="post" class="am-form am-text-sm" id="select_form" >
				...
				<div class="am-u-sm-12">
					<div class="card-box">
						<figure data-am-widget="figure" class="am am-figure am-figure-default "   data-am-figure="{  pureview: 'true' }">
							<img src="<?php echo ($pic_url); ?>.?20150421" data-rel="<?php echo ($pic_url); ?>.?20150421" alt="价值重量散点图"/>
