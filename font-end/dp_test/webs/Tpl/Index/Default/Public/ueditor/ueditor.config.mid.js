...
(function () {
    ...
    var MEDIAID = window.MEDIA_OBJID;
    ...
    var mediaUrl=curWwwPath.substring(0,pos);
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,filePath:"http://localhost/xbjsyx_new/"//URL + "php/"               //附件修正地址，同imagePath
        ...
        ,imageManagerPath:URL + "php/upload1"                                    //图片修正地址，同imagePath
        ...
        //扩展媒体管理功能
        ,enableMediaManage:true				//是否启用媒体管理功能
        ,mediaViewURL:mediaUrl+'/xbjsyx_new/index.php?g=Admin&m=Media&a=index'  //媒体浏览地址
        ,mediaAddURL:mediaUrl+'/xbjsyx_new/index.php?g=Admin&m=Media&a=add'  //媒体添加地址
        ,mediaDelURL:mediaUrl+'/xbjsyx_new/index.php?g=Admin&m=Media&a=del'  //媒体添加地址
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
    	, toolbars:[
                ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                    'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
