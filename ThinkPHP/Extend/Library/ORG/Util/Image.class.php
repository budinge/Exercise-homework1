...
class Image {
    ...
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify') {
        ...
        for ($i = 0; $i < $length; $i++) {
        	...
        	//参数含义 imagettftext ($image, $size, $angle, $x, $y, $color, $fontfile, $text)
            imagettftext($im, 20, 0, ($i+1) * $width * 0.17, mt_rand($height * 0.7, $height * 0.9), $stringColor, THINK_PATH . '/../Public/font/Arial.ttf', $randval[$i]);	//add by songyb(2015-06-29)
        }
