...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'imageleft':'左浮动', 'imageright':'右浮动', 'attachment':'媒体管理', 'imagecenter':'居中', 'wordimage':'图片转存',
    ...
    'attachment':{
        'static':{
        	'lang_tab_local':'上传文件',
        	'lang_tab_remote':'媒体库',
        	'lang_imgLoading':'文件加载中……',
            'lang_input_fileStatus':' 当前未上传文件',
            'startUpload':{style:"background:url(upload.png) no-repeat;"},
			'imgType':{title:"图片类型", options:["所有多媒体项目", "上传到本文章的", "图像", "音频","视频","文档","压缩包"]}, //select的option
            'imgSearchTxt':{value:"请输入搜索关键词"},
            'imgSearchBtn':{value:"搜索一下"},
        },
        'browseFiles':'文件浏览…',
        'uploadSuccess':'上传成功!',
